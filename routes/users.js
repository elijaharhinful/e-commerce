                                    ...
                                    token.save(function (err) {
                                        if (err) {
                                            ...
                                            let info = await transporter.sendMail({
                                                from: '"My Website 👻" mywebsite@demo.com', // sender address
                                                ...
                                                text: 'Hello ' + user.username + ',\n\n' +
                                                    ...
                                                    'If you have any trouble clicking the link, please copy and paste the URL below into your prefered web browser.\n\n' +
                ...
                crypto.randomBytes(3, function (err, buf) {
                    ...
                    user.save(function (err) {
                        if (err) {
                            ...
                            req.flash('success', 'Successful! Enter Token');
                            res.render('token', {
                                title: "Token",
                                user: null,
                                user_id: user.id,
